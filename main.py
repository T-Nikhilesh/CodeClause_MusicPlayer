...
if __name__ == '__main__':
	...
	img = PhotoImage(file='F:\\Code Clause Projects\\Music Player\\buttons\\musician.gif')
	next_ = PhotoImage(file = 'F:\\Code Clause Projects\\Music Player\\buttons\\next.gif')
	prev = PhotoImage(file='F:\\Code Clause Projects\\Music Player\\buttons\\previous.gif')
	play = PhotoImage(file='F:\\Code Clause Projects\\Music Player\\buttons\\play.gif')
	pause = PhotoImage(file='F:\\Code Clause Projects\\Music Player\\buttons\\pause.gif')
